                            ...
                            <div className="newsletter-input">
                                ...
                                <button title="click me" type="button">
                                    <svg width="15" height="11" viewBox="0 0 15 11" fill="none"
                                        ...
                                        <title>icon</title>
                                        <path d="M0.799805 5.5H12.7998" stroke="#aaaeb6" strokeWidth="1.2"
                                            strokeLinecap="round" strokeLinejoin="round"/>
                                        <path d="M9.49976 1L13.9998 5.5L9.49976 10" stroke="#aaaeb6" strokeWidth="1.2"
                                            strokeLinecap="round" strokeLinejoin="round"/>
                                    </svg>
                                </button>
                            </div>
                ...
                <div className="row">
                    ...
                    <div className="col-12 col-md-6">
                        <div className="payments-footer">
                            <a href="google.com">
                                <svg className="payment-icons__icon" xmlns="http://www.w3.org/2000/svg" role="img"
                            ...
                            <a href="google.com">
                                <svg className="payment-icons__icon" version="1.1" xmlns="http://www.w3.org/2000/svg" role="img"
                                    x="0" y="0" width="38" height="24" viewBox="0 0 165.521 105.965" xmlSpace="preserve"
                            ...
                            <a href="google.com">
                                <svg className="payment-icons__icon" viewBox="0 0 38 24" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <a href="google.com">
                                <svg className="payment-icons__icon" width="38" height="24" role="img"
